...
//		private ArrayList<Student> studentList;
		...
		public MainController()
		{
			...
			salesReportUI = new SalesReportUI(report);
			staffUI = new StaffUI();
			tableUI = new TableUI();
			
			invoiceCtrl = new InvoiceCtrl(tableCtrl);
			menuCtrl = new MenuCtrl();
			orderCtrl = new OrderCtrl(tableCtrl);
			reservationCtrl = new ReservationCtrl();
			salesReportCtrl = new SalesReportController(report, salesReportUI);
